    ...
    if( chara.state == STOP ){
        ...
        if( chara.dir ){
            if( chara.anime < chara.anime_time/2 ){
                ...
                chara_direction = chara.dir;
                if(chara.y > 0 && chara.y <= 630){
                    mower_fire = true;
                }
                if(chara.y > 630 && chara.y <= 1260){
                    dart_fire = true;
                }
                if(chara.y  >1260 && chara.y <= 1890){
                    arrow_fire = true;
                }
            }
        }else{
            if( chara.anime < chara.anime_time/2 ){
                ...
                al_play_sample_instance(chara.atk_Sound);
                chara_direction = chara.dir;
                if(chara.y > 0 && chara.y <= 472){
                    mower_fire = true;
                }
                if(chara.y > 472 && chara.y <= 944){
                    dart_fire = true;
                }
                if(chara.y  >944 && chara.y <= 1417){
                    arrow_fire = true;
                }
            }
        }
